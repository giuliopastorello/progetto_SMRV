...
16 valori per ogni giornata. Poiché sulle quattro variabili abbiamo il 
vincolo della popolazione costante espresso dall'equazione \ref{eq::pop},
si riesce a esprimere uno dei quattro coefficienti in funzione degli altri 
tre, e quindi i valori da calcolare si riducono a 12 per ogni giornata. 
Nel metodo di Eulero per ogni variabile viene calcolato un solo valore 
al giorno, dunque calcoliamo 4 valori per ogni giorno.\\
???NON SI PUO' FARE LA STESSA COSA CON EVOLVE()????
\end{document}
