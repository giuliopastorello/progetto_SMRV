...
Per compilare serve fare la build con \verb|cmake .|, poi 
\verb|cmake --build .|. Una volta fatto questo vengono prodotti due
...
utilizzando poi il comando \verb|add_subdirectory(matplotplusplus)|
su CMake.
\end{document}
