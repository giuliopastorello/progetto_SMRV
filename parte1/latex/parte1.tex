...
giornata.\\
\section{Il Codice}
\hspace{\parindent} Per rendere più leggibile il codice si è deciso di
...
Si è definita una struct \verb|State|: 
\begin{minted}{C++}
    struct State {
        int S; 
        int M; 
...
Si è poi scritto la classe \verb|Infection|
\begin{minted}{C++}
    class Infection {
...
totale.
\subsection{display}
In \verb|Infection.cpp| si sono raggruppati i metodi che, come da 
...
colorare quanto stampato su terminale per colorare i nomi delle 
variabili.
\end{document}
